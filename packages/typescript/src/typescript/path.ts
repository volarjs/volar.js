import { endsWith, equateStringsCaseInsensitive, equateStringsCaseSensitive, lastOrUndefined, some, startsWith, stringContains } from "./core.js";
import { CharacterCodes, type Path } from "./types.js";
